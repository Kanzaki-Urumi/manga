...
$mangaList = new User($id);

?>
<div class="col-12 collection-gallery mx-auto">
    <div class="row justify-content-around">
        <?php foreach($mangaList->manga as $id => $elem):
            $infoManga = new Manga( (int) $id );
        ?>
            <div class="px-2 col-12 col-lg-6 col-xl-4 blocMangaAdd">
                <div class="row justify-content-between border border-info p-3 m-2">
                    ...
                    <div class="col-12 mt-2">
                        <a href="mangaTomeList.php?id=<?= $id ?>"><button type="button" class="btn btn-outline-primary col-12">Voir Tomes</button></a>
                    </div>
                    <div class="col-12 mt-2">
                        <button type="button" class="btn btn-outline-danger col-12" data-id="<?= $id ?>">Retirer</button>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
